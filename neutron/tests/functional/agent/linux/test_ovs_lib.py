...
class TestOvsLib(base.BaseOVSLinuxTestCase):
    ...
    def test_get_bridge_name_for_datapath_id_nonexistent(self):
        datapath_id = self.bridge.get_datapath_id()
        # NOTE(yamamoto): The datapath-id below can not be found because
        # datapath-id auto-generated by Open vSwitch always have
        # the top most bits 0.
        self.assertRaises(ovs_lib.DatapathIdNotFound,
                          ovs_lib.get_bridge_name_for_datapath_id,
                          self.root_helper, 0xffff000000000000)
