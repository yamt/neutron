...
class _OVSAgentTestBase(object):
    def setUp(self):
...
class _ARPSpoofTestCase(_OVSAgentTestBase):
...
class ARPSpoofOFCtlTestCase(_ARPSpoofTestCase,
...
class CanaryTableOFCtlTestCase(_CanaryTableTestCase,
                               base.BaseIPVethTestCase,
                               test_ovs_lib.OVSBridgeTestBase):
    _MAIN_MODULE = 'neutron.plugins.openvswitch.agent.ovs_ofctl.main'
