...
class TestOFAgentFlows(ofa_test_base.OFATestBase):
    ...
    def test_check_in_port_add_local_port(self):
        ...
        expected_calls = [
            call(ofpp.OFPFlowMod(dp,
                 instructions=[ofpp.OFPInstructionWriteMetadata(
    ...
    def test_local_flood_update(self):
        ...
        expected_calls = [
            call(ofpp.OFPFlowMod(dp,
                 ...
                 ofp.OFPIT_APPLY_ACTIONS, [ofpp.OFPActionOutput(port=1),
                 ofpp.OFPActionOutput(port=2), ofpp.OFPActionOutput(port=3)])],
                 match=ofpp.OFPMatch(
