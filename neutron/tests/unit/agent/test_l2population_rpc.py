...
class TestL2populationRpcCallBackTunnelMixin(
    ...
    def test__fdb_chg_ip(self):
        m_update_info_for_arp_reply = mock.Mock()
        self.fakeagent.update_info_for_arp_reply = m_update_info_for_arp_reply
        ...
        self.assertEqual(sorted(expected),
                         sorted(m_update_info_for_arp_reply.call_args_list))
    ...
    def test__fdb_chg_ip_no_lvm(self):
        ...
        self.assertFalse(m_update_info_for_arp_reply.call_count)
