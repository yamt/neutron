...
class TestOvsNeutronAgent(object):
    ...
    def setUp(self):
        ...
        with contextlib.nested(
            ...
            self.agent = self.mod_agent.OVSNeutronAgent(self.backend_info,
                                                        **kwargs)
    ...
    def test_update_ports_returns_changed_vlan(self):
        br = self.br_int_cls('br-int', driver_args=self.driver_args)
    ...
    def test_setup_physical_bridges(self):
        with contextlib.nested(
            ...
            expected_calls = [
                mock.call.phys_br_cls('br-eth', driver_args=self.driver_args),
...
class TestOvsDvrNeutronAgent(object):
    ...
    def _test_port_bound_for_dvr_on_vlan_network(self, device_owner,
        ...
        phys_br = mock.create_autospec(self.br_phys_cls(
            'br-phys', driver_args=self.driver_args))
        int_br.set_db_attribute.return_value = True
