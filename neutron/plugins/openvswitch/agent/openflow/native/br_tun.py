...
from neutron.plugins.openvswitch.agent.openflow.native import br_dvr_process
from neutron.plugins.openvswitch.agent.openflow.native import ovs_bridge
...
class OVSTunnelBridge(ovs_bridge.OVSAgentBridge,
    ...
    def deferred(self):
        # REVISIT(yamamoto): For API compat with ovs-ofctl driver.
        return self
